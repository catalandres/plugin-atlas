...
import { GenericMetadataType, MetadataType } from '../metadataReader/metadataTypes.js';
...
export interface GenericTable {
  ...
  readonly metadataType: GenericMetadataType;
  readonly columns: TableColumn[];
}

export interface Table<T extends Metadata> extends GenericTable {
  readonly metadataType: MetadataType<T>;
}
